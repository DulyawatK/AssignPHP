...
<div class="container">
        ...
        <h2>ยืนยันเพื่อลบข้อมูลนี้</h2><br>
    <form id="form1" name="form1" method="post" action="deletebiosuccess.php">
    <p>
        ...
        <p>
            ...
            <input type="text" name="emp_name" id="emp_name" value="<?=$row['emp_name'];?>"readonly>
        ...
        <p>
            ...
            <input type="text" name="emp_mobile" id="emp_mobile" value="<?=$row['emp_mobile'];?>"readonly>
        ...
        <p>
            ...
            <input type="text" name="emp_email" id="emp_email" value="<?=$row['emp_email'];?>"readonly>
        ...
        <p>
            ...
            <input type="text" name="emp_pass" id="emp_pass" value="<?=$row['emp_pass'];?>"readonly>
        ...
        <p>
            ...
            <input type="text" name="emp_add" id="emp_add" value="<?=$row['emp_add'];?>"readonly>
